...
<head>
  ...
  <title>Red Warriors - connect the donors</title>
...
<body id="top">
  ...
  <header class="header">
      ...
      <div class="container">
        <ul class="contact-list">
          <li class="contact-item">
            ...
            <a href="mailto:redwarriors1003@gmail.com" class="contact-link">redwarriors1003@gmail.com</a>
          </li>
          <li class="contact-item">
            <ion-icon name="call-outline"></ion-icon>
            <a href="tel:+918603871643" class="contact-link">+918603871643</a>
          </li>
        </ul>
    ...
    <div class="header-bottom" data-header>
      <div class="container">
        <a href="#" class="logo">Red Warriors</a>
    ...
    <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')"
        ...
        <div class="container">
          <div class="hero-content">
            ...
            <p class="section-subtitle">Red Warriors</p>
            <h1 class="h1 hero-title">Contact Us</h1>
            <h2 style="color: var(--royal-blue-light);">Address</h2>
            <p class="hero-text">
            Red Warriors, SRM Road, Near SRM Institute Of Science and Technology.<br>
            Potheri, Tamil Nadu, INDIA<br>
            Pin 603203
            </p>
            <h2 style="color: var(--royal-blue-light);">Contact Details</h2>
            <p class="hero-text">
            MOBILE: +91 8603871643 | TELEPHONE: XXXX-XXXXX<br>
            EMAIL : redwarriors1003@gmail.com<br>
            </p>
  ...
  <footer class="footer">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <address class="item-text">
              Srm Institute of Scienece And Technology,<br>
              Potheri, Tamil Nadu, INDIA
            </address>
          </a>
          </li>
          <li class="footer-item">
            ...
            <a href="tel:+918603871643" class="footer-link">+918603871643</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
            </div>
            <a href="mailto:help@example.com" class="footer-link">redwarriors1003@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <div class="container">
        <p class="copyright">
          &copy; 2024 All Rights Reserved by Red Warriors.
        </p>
        <ul class="social-list">
          <li>
            <a href="https://www.facebook.com/andro.pool.54?mibextid=ZbWKwL" class="social-link">
